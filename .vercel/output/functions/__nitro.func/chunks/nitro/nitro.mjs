...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "04f2ded1-b93b-4885-980b-bf0a9e04ead1",
...
const _lazy_TaOOvl = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_TaOOvl, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_TaOOvl, lazy: true, middleware: false, method: undefined }
];
