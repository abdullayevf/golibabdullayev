...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CptKRg1r.mjs')
  },
  {
    name: "resume",
    path: "/resume",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DM_wINf9.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-l_50kwDE.mjs'));
